...
<body>
  ...
  <div class="esimerkki koodisini">
    <?php
      ...
      $ympyran_pituus = (4/3) * $pii * pow($sade, 3);
      ...
      echo "<h3>Ympyrän pituuden laskeminen</h3>";
      echo "Ympyrän pituus lasketaan kaavalla:<br>";
      echo "V = (4/3) * π * säde<sup>3</sup><br>";
      echo "Jos säde on $sade, pituus on $ympyran_pituus.<br><br>";
    ?>
  </div>
</body>
</html>
